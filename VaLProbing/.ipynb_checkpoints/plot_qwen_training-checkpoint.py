...
model_infos = [
    ...
    #['FILM-Qwen-7B', '#08D9D6', '#08D9D6', 'dotted', 's'],
    ['FILM-Qwen-7B','#F9A826', '#F9A826', '-.', '^']
]
...
PDF_OUTPUT_PATH = os.path.join(FIGURES_DIR, 'qwen_train_probing_fig.pdf')
JPG_OUTPUT_PATH = os.path.join(FIGURES_DIR, 'qwen_train_probing_fig.jpg')
