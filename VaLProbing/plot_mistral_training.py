...
model_infos = [
    ['Mistral-7B-Instruct-v0.2', '#FF2E63', '#FF2E63', ':', 'o'],        
    ['Mistral-7B-Instruct-v0.3', '#08D9D6', '#08D9D6', 'dotted', 's'],
    ['FILM-Mistral-v0.2-7B', '#F9A826', '#F9A826', '-.', '^'],
    ['FILM-Mistral-v0.3-7B', '#252A34', '#252A34', '--', 'v'],
]
...
PDF_OUTPUT_PATH = os.path.join(FIGURES_DIR, 'mistral_train_probing_fig.pdf')
JPG_OUTPUT_PATH = os.path.join(FIGURES_DIR, 'mistral_train_probing_fig.jpg')
...
fig.suptitle('Mistral', fontsize=fontsize * 1.5, y=1.05)
