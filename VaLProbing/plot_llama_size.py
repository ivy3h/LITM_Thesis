...
model_infos = [
    ['Llama-3.2-1B-Instruct', '#FF2E63', '#FF2E63', ':', 'o'],        
    ['Llama-3.2-3B-Instruct', '#F9A826', '#F9A826', '-.', '^']
]
...
PDF_OUTPUT_PATH = os.path.join(FIGURES_DIR, 'llama_probing_fig.pdf')
JPG_OUTPUT_PATH = os.path.join(FIGURES_DIR, 'llama_probing_fig.jpg')
...
fig.suptitle('LLaMA 3.2', fontsize=fontsize * 1.7, y=1.05)
