...
model_infos = [
    ['Qwen2.5-7B-Instruct', '#FF2E63', '#FF2E63', ':', 'o'],        
    ['LLaMA-3.2-3B-Instruct', '#08D9D6', '#08D9D6', 'dotted', 's'],
    ['Mistral-7B-Instruct-v0.2', '#BCCCDC', '#BCCCDC', '--', 'v'],
    ['Mistral-7B-Instruct-v0.3', '#F9A826', '#F9A826', '-.', '^'],
]

fontsize = 20

# --- File Paths ---
PROJECT_BASE = '/root/FILM_old' 
...
PDF_OUTPUT_PATH = os.path.join(FIGURES_DIR, 'probing_fig.pdf')
JPG_OUTPUT_PATH = os.path.join(FIGURES_DIR, 'probing_fig.jpg')
